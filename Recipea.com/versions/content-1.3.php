...
<html lang="en">
    ...
    <body>
        <img src="img/gallery/dotted-line-long.png" al="dotted-line-long" />

        <section>
            <h1 class="invisible">Lemon Poppy Seed Scones </h1>
            <div>
                <img src="img/gallery/green-bubble.png" alt="green bubble icon" />
            ...
            <section>
                ...
                <div class="vertical-down-gradient slider-size padding-m margin-right-m float-left">
                    <img src="img/master/content/process-slider/left-arrow.png" alt="left-arrow" class="margin-right-s" />

                    <img src="img/master/content/process-slider/slider-step-1.png" alt="slider-step-1" />
                    <img src="img/master/content/process-slider/slider-step-2.png" alt="slider-step-2" />
                    <img src="img/master/content/process-slider/slider-step-3.png" alt="slider-step-3" class="margin-right-s" />

                    <img src="img/master/content/process-slider/right-arrow.png" alt="right-arrow" />
                </div>
<!--                <img src="img/master/content/process-slider/image-slider-background-colour.png" alt="image-slider-background-colour" />-->
            ...
            <section>
                ...
                <section class="recipe-details-panel margin-top-m2  margin-right-m2 text-colour-2"> <!-- float-left -->
          ...
          <!--<img src="img/master/content/orange-frame-medium-top.png" alt="orange-frame-medium-top" />-->
                    ...
                    <div class="recipe-details-sub-panel">
                        ...
                        <section class="border-box text-colour-2">
                            <h4 class="invisible">About</h4> 
                ...
                </section> <!--/recipe-details-panel-->

                <!--==============================================================-->

                <section class="margin-top-m2 margin-right-m2"> <!--float-left -->
                    ...
                    <div class="recipe-details-section border-box text-colour-2 float-left">
                        <section>
                            <h4 class="invisible">Ingredients</h4> 

                            <section class="recipe-detail-section-row">
                                <h5 class="invisible">Ingredients - contents</h5> 

                                <div class="paragraph-m">
                                    <ul class="heading-m line-height-s margin-top-s">
        ...
        </section> <!--/recipe: Lemon poppy seed scones -->


        <!--============================================-->
<!--        <section class="margin-top-m2 float-left">
            <h3 class="invisible">Ingredients</h3>
            ...
            <p class="heading-m line-height-s margin-top-s">For the scones</p>
            <ul>
                <li>2 cups all purpose flour</li> 
                <li>1 cup whole wheat flour</li> 
                <li>1/2 cup sugar, plus more to sprinkle </li>
